...
<div id='midsection'>
  ...
  <div id='content'>
    <h1>WS2000 weatherstation</h1>
    <p>Current conditions in the Thalreit region.</p>

<?php
  $ws2000_db = "/data/wetter/logs/ws2000_test/ws2000.db";
...
?>
    <p>Data measured with WS2000 weatherstation. Values are always 
    most recent ones.</p>
  </div>
</div>
<div id='footer'>
