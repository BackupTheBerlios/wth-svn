...
<div id='midsection'>
  <div id='leftcol'>
    <img src="wmr9x8/windsensor_average_windspeed.png">
    <img src="wmr9x8/windsensor_gust_windspeed.png">
    <img src="wmr9x8/windsensor_wind_direction.png">
    <img src="wmr9x8/windsensor_windchill.png">
  </div>
  <div id='content'>
    <h1>WMR 928 NX weatherstation</h1>
    <p>Current conditions in the Thalreit region.</p>

<?php
  $wth_db = "/data/wetter/logs/wmr9x8/wmr9x8.db";
