...
#
# dbmk
# create SQLITE database for ws2000 and pcwsr weatherstation
#
# $Id: dbmk 217 2008-11-03 22:03:29Z vjahns $
#
...
if ( $options{w} ) {
  ...
  $dbh->do(" INSERT INTO parameternames VALUES ('2','Relative Humidity','per cent') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('3','Precipitation','mm m-2') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('4','Windspeed','m s-1') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('5','Winddrct Variance','deg') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('6','Winddirection','deg') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('7','Pressure','hPa') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('8','Precpt. Intensity','mm h-1') ");
  ...
  #
  # sensor1
  $dbh->do(" INSERT INTO sensorparameters VALUES ('1','1','1') "); # temperature
  $dbh->do(" INSERT INTO sensorparameters VALUES ('2','1','2') "); # humidity

  # sensor2
  $dbh->do(" INSERT INTO sensorparameters VALUES ('3','2','1') "); # temperature
  $dbh->do(" INSERT INTO sensorparameters VALUES ('4','2','2') "); # humidity
  ...
  $dbh->do(" INSERT INTO sensorparameters VALUES ('38','9','8') "); # precipitation intensity
  # Windsensor
  ...
  # Rainsensor
  $dbh->do(" INSERT INTO sensorupdate VALUES ('17','0') "); # precipitation
  $dbh->do(" INSERT INTO sensorupdate VALUES ('38','0') "); # precipitation intensity
  # Windsensor
  ...
  $dbh->do(" INSERT INTO parameternames VALUES ('3','Precipitation','mm m^-2') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('4','Windspeed','m s^-1') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('5','Winddir. Variation','deg') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('6','Winddirection','deg') ");
  $dbh->do(" INSERT INTO parameternames VALUES ('7','Pressure','hPa') ");
